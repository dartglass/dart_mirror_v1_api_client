...
- VIEW_WEBSITE - Open the payload of the menu item in the browser. */
  ...
  /** A generic payload whose meaning changes depending on this MenuItem's action. When the action is VIEW_WEBSITE, the payload is the URL of the website to view. */
  core.String payload;
